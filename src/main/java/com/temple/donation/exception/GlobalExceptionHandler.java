...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MessageResponse> noResource(NoResourceFoundException e) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(MessageResponse.of("Not found"));
    }
